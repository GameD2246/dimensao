...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Dimensão</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Conecte usando o 
        Facebook</a>
      <a href="#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Conecte usando o
        Google+</a>
    </div>
    <!-- /.social-auth-links -->
